...
const videogamesFilter = videogames.filter(game => game.genders.includes('RPG'));
const videogamesAVG = videogamesFilter.reduce((acc, game) => acc + game.score, 0) / videogamesFilter.length;

console.log(videogamesFilter,'Media: ' + videogamesAVG);
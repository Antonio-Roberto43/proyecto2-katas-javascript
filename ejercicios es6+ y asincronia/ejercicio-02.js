...
const pointsListCombination = [...pointsList, ...pointsLis2];
console.log(pointsListCombination);

// 2.4 Dado los siguientes objetos. Crea un nuevo objeto fusionando los dos con spread operators.
const toyUpdate = {lights: 'rgb', power: ['Volar like a dragon', 'MoonWalk']};

const toyCombination = {...toy, ...toyUpdate};
console.log(toyCombination);
